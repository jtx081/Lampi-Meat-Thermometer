...
class ThermometerApp(App):
    ...
    display_target_temp_message = StringProperty("Desired Temperature: " + str(target_temp) + " F")
    temp = 0
    ...
    def build(self):
        ...
        self.popupWindow = Popup(title="MESSAGE: Goal temp. reached!", content=self.popup, size_hint=(None, None), size=(240, 320), auto_dismiss=False)
    ...
    def goal_temp_received(self, client, userdata, message):
        ...
        self.display_target_temp_message = 'Desired Temperature: {} F'.format(new_goal_temp)
